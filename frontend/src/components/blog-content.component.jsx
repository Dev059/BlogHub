...
const BlogContent = ({block}) => {
    ...
    if(type == "paragraph") {
        ...
        // dangerouslySetInnerHtml is the react prop 
        // when in <p>{data.text}<p/> is passed then all the html tag as text format will render on the page
        // but using it in dangerouslySetInnerHtml with __html set all the tag as html code and render html rather than text format
