...
const SearchPage = () => {
    ...
    const resetState = () => {
        // because if previously searched then data is still present in the blog and users ans state and when new things is searched then the new user and blog will get added in the state and hence we have to delete the previous state
        setBlog(null);
        setUsers(null);
    }
